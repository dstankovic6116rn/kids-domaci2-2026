 ...
 *
 * Routing: forwarded hop-by-hop (see ListItemIndexHandler) until the message
 ...
 * recompute it.
 */
public class ListItemIndexMessage extends BasicMessage {
	...
	public ListItemIndexMessage(int senderPort, int receiverPort, NameIndexEntry entry, int nameKey) {
		super(MessageType.LIST_ITEM_INDEX, senderPort, receiverPort);
		this.entry = entry;
